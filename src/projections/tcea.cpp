...
PJ_XY tcea_s_forward (PJ_LP lp, PJ *P) {           /* Spheroidal, forward */
    PJ_XY xy = {0.0,0.0};
...
PJ_LP tcea_s_inverse (PJ_XY xy, PJ *P) {           /* Spheroidal, inverse */
    PJ_LP lp = {0.0, 0.0};
    double t;
...
PJ *PROJECTION(tcea) {
    P->inv = PJ_MAKE_KERNEL(tcea_s_inverse);
    P->fwd = PJ_MAKE_KERNEL(tcea_s_forward);
    P->es = 0.;
    return P;
}
