...
PJ_XY gall_s_forward (PJ_LP lp, PJ *P) {           /* Spheroidal, forward */
    PJ_XY xy = {0.0,0.0};
    (void) P;
...
PJ_LP gall_s_inverse (PJ_XY xy, PJ *P) {           /* Spheroidal, inverse */
    PJ_LP lp = {0.0,0.0};
    (void) P;
...
PJ *PROJECTION(gall) {
    ...
    P->inv = PJ_MAKE_KERNEL(gall_s_inverse);
    P->fwd = PJ_MAKE_KERNEL(gall_s_forward);
