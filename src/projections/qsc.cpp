...
PROJ_NOINLINE PJ_XY qsc_e_forward (PJ_LP lp, __global PJ *P) {          /* Ellipsoidal, forward */
    PJ_XY xy = {0.0,0.0};
...
PROJ_NOINLINE PJ_LP qsc_e_inverse (PJ_XY xy, __global PJ *P) {          /* Ellipsoidal, inverse */
    PJ_LP lp = {0.0,0.0};
    struct pj_opaque *Q = (struct pj_opaque*)P->opaque;
